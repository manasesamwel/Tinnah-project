        ...
        <div class="table-wrapper" id="empty">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        <a href="" class="section-btn"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
                        <a href="#" onclick="window.print()" class="section-btn"><i class="material-icons">&#xE24D;</i> <span>Print</span></a>
                    </div>
                </div>
            </div>
