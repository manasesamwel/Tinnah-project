                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewPizzaList.php?catid=' . $catId . '" class="section-btn">View All</a>
                        </div>
                    </div>
                </div>';
            }
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="section-btn mx-2">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="section-btn mx-2">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="section-btn mx-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="section-btn">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
