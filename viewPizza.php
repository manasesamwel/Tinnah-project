    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $pizzaName . '</h3>
                <h5 style="color: #ff0000">Tsh. '.$pizzaPrice. '/-</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="section-btn my-2">Add to Cart</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="section-btn my-2">Go to Cart</button></a>';
                    }
                }
                else{
                    echo '<button class="section-btn my-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                }
                echo '</form>
                <h6 class="my-1"> View </h6>
                <div class="mx-4">
                    <a href="orders.php?catid=' . $pizzaCategorieId . '" class="active text-dark">
                    <i class="fas fa-qrcode"></i>
                        <span>All Pizza</span>
                    </a>
                </div>
                <div class="mx-4">
                    <a href="orders.php" class="active text-dark">
                    <i class="fas fa-qrcode"></i>
