...
echo '<nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="index.php">Delicious<span>.</span> restaurant</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
        <a class="nav-link" href="index.php#team">Chief</a>
      </li>
        ...
        <form method="get" action="/OnlinePizzaDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
          ...
          <button class="section-btn my-2 my-sm-0" type="submit">Search</button>
        </form>';
        ...
        echo '<a href="viewCart.php"><button type="button" class="section-btn" title="MyCart">
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="section-btn"  data-toggle="modal" data-target="#loginModal">Login</button>
          <button type="button" class="section-btn"  data-toggle="modal" data-target="#signupModal">SignUp</button>';
        }
